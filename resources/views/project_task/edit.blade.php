...
<div class="modal-body">
    ...
    @endif
     @can('view project task')
        <a href="#!" data-size="md" data-url="{{ route('projects.tasks.show',[$task->project_id,$task->id]) }}" data-ajax-popup="true"  data-bs-original-title="{{__('View')}}">
            
            <span class="btn btn-primary btn-icon btn-sm" ><i class="ti ti-bookmark"></i>{{__('View')}}</span>
        </a>
    @endcan
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('description', null, ['class' => 'form-control summernote-simple','rows'=>'5','id'=>'des','data-toggle' => 'autosize', 'placeholder'=>__('Enter Description')]) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('response', null, ['class' => 'form-control summernote-simple','rows'=>'5','id'=>'res','data-toggle' => 'autosize', 'placeholder'=>'Phản hồi']) }}
            </div>
        </div>
